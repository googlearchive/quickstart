define(['dart_sdk', 'packages/angular/src/common/pipes/invalid_pipe_argument_exception.template', 'packages/angular/core.template'], function(dart_sdk, invalid_pipe_argument_exception, core) {
  ...
  dart.fn(src__common__pipes__date_pipe$46template.initReflector, VoidTovoid());
  ...
  }, '{"version":3,"sourceRoot":"","sources":["date_pipe.template.dart"],"names":[],"mappings":";;;;;;;;;;;MAaI,iDAAQ;YAAG;;;;;AAEb,kBAAI,iDAAQ,GAAE;AACZ;;AAEF,wDAAW;AAEX,IAAM,4EAAa;AACnB,IAAM,6BAAa;EACrB","file":"date_pipe.template.ddc.js"}');
  // Exports:
  return {
