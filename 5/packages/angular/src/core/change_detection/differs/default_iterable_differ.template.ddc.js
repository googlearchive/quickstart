define(['dart_sdk', 'packages/angular/src/facade/exception_handler.template'], function(dart_sdk, exception_handler) {
  ...
  dart.fn(src__core__change_detection__differs__default_iterable_differ$46template.initReflector, VoidTovoid());
  ...
  }, '{"version":3,"sourceRoot":"","sources":["default_iterable_differ.template.dart"],"names":[],"mappings":";;;;;;;;;;MAUI,iFAAQ;YAAG;;;;;AAEb,kBAAI,iFAAQ,GAAE;AACZ;;AAEF,wFAAW;AAEX,IAAM,gDAAa;EACrB","file":"default_iterable_differ.template.ddc.js"}');
  // Exports:
  return {
