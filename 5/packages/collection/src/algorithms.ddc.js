define(['dart_sdk', 'packages/collection/src/utils'], function(dart_sdk, utils) {
  ...
  let ListOfTAndT__Toint = () => (ListOfTAndT__Toint = dart.constFn(dart.gFnType(T => [core.int, [core.List$(T), T], {compare: dart.fnType(core.int, [T, T])}])))();
  let ListOfTAndT__Toint$ = () => (ListOfTAndT__Toint$ = dart.constFn(dart.gFnType(T => [core.int, [core.List$(T), T], {compare: dart.fnType(core.int, [T, T])}])))();
  let List__Tovoid = () => (List__Tovoid = dart.constFn(dart.fnType(dart.void, [core.List], [core.int, core.int])))();
  let ListAndintAndintTovoid = () => (ListAndintAndintTovoid = dart.constFn(dart.fnType(dart.void, [core.List, core.int, core.int])))();
  let ListOfT__Tovoid = () => (ListOfT__Tovoid = dart.constFn(dart.gFnType(T => [dart.void, [core.List$(T)], {compare: dart.fnType(core.int, [T, T]), start: core.int, end: core.int}])))();
  let ListOfT__Tovoid$ = () => (ListOfT__Tovoid$ = dart.constFn(dart.gFnType(T => [dart.void, [core.List$(T)], {start: core.int, end: core.int, compare: dart.fnType(core.int, [T, T])}])))();
  let ListOfTAndFnAndint__Tovoid = () => (ListOfTAndFnAndint__Tovoid = dart.constFn(dart.gFnType(T => [dart.void, [core.List$(T), dart.fnType(core.int, [T, T]), core.int, core.int, core.List$(T), core.int]])))();
  let ListOfTAndFnAndint__Tovoid$ = () => (ListOfTAndFnAndint__Tovoid$ = dart.constFn(dart.gFnType(T => [dart.void, [core.List$(T), dart.fnType(core.int, [T, T]), core.int, core.int, core.List$(T), core.int]])))();
  let FnAndListOfTAndint__Tovoid = () => (FnAndListOfTAndint__Tovoid = dart.constFn(dart.gFnType(T => [dart.void, [dart.fnType(core.int, [T, T]), core.List$(T), core.int, core.int, core.List$(T), core.int, core.int, core.List$(T), core.int]])))();
  ...
  dart.fn(src__algorithms.binarySearch, ListOfTAndT__Toint());
  ...
  dart.fn(src__algorithms.lowerBound, ListOfTAndT__Toint$());
  ...
  dart.fn(src__algorithms.shuffle, List__Tovoid());
  ...
  dart.fn(src__algorithms.reverse, List__Tovoid());
  ...
  dart.fn(src__algorithms._reverse, ListAndintAndintTovoid());
  ...
  dart.fn(src__algorithms.insertionSort, ListOfT__Tovoid());
  ...
  dart.fn(src__algorithms.mergeSort, ListOfT__Tovoid$());
  ...
  dart.fn(src__algorithms._movingInsertionSort, ListOfTAndFnAndint__Tovoid());
  ...
  dart.fn(src__algorithms._mergeSort, ListOfTAndFnAndint__Tovoid$());
  ...
  dart.fn(src__algorithms._merge, FnAndListOfTAndint__Tovoid());
