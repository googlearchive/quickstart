define(['dart_sdk'], function(dart_sdk) {
  ...
  src__empty_unmodifiable_set.EmptyUnmodifiableSet$ = dart.generic(E => {
    ...
    dart.setStaticMethodSignature(EmptyUnmodifiableSet, () => ({_throw: dart.gFnType(T => [T, []])}));
  ...
  src__wrappers.DelegatingIterable$ = dart.generic(E => {
    ...
    dart.setStaticMethodSignature(DelegatingIterable, () => ({typed: dart.gFnType(E => [core.Iterable$(E), [core.Iterable]])}));
  ...
  src__wrappers.DelegatingList$ = dart.generic(E => {
    ...
    dart.setStaticMethodSignature(DelegatingList, () => ({typed: dart.gFnType(E => [core.List$(E), [core.List]])}));
    dart.setGetterSignature(DelegatingList, () => ({
      __proto__: dart.getGetters(DelegatingList.__proto__),
      [_listBase]: dart.fnType(core.List$(E), []),
  ...
  src__unmodifiable_wrappers.NonGrowableListMixin$ = dart.generic(E => {
    ...
    dart.setStaticMethodSignature(NonGrowableListMixin, () => ({_throw: dart.gFnType(T => [T, []])}));
  ...
  src__wrappers.DelegatingSet$ = dart.generic(E => {
    ...
    dart.setStaticMethodSignature(DelegatingSet, () => ({typed: dart.gFnType(E => [core.Set$(E), [core.Set]])}));
    dart.setGetterSignature(DelegatingSet, () => ({
      __proto__: dart.getGetters(DelegatingSet.__proto__),
      [_setBase]: dart.fnType(core.Set$(E), [])
    }));
  ...
  src__unmodifiable_wrappers.UnmodifiableSetMixin$ = dart.generic(E => {
    ...
    dart.setStaticMethodSignature(UnmodifiableSetMixin, () => ({_throw: dart.gFnType(T => [T, []])}));
  ...
  src__unmodifiable_wrappers.UnmodifiableMapMixin$ = dart.generic((K, V) => {
    ...
    dart.setStaticMethodSignature(UnmodifiableMapMixin, () => ({_throw: dart.gFnType(T => [T, []])}));
    dart.setSetterSignature(UnmodifiableMapMixin, () => ({
      __proto__: dart.getSetters(UnmodifiableMapMixin.__proto__),
      first: dart.fnType(dart.void, [dart.dynamic]),
      last: dart.fnType(dart.void, [dart.dynamic])
    }));
  ...
  src__wrappers.DelegatingQueue$ = dart.generic(E => {
    ...
    dart.setStaticMethodSignature(DelegatingQueue, () => ({typed: dart.gFnType(E => [collection.Queue$(E), [collection.Queue]])}));
    dart.setGetterSignature(DelegatingQueue, () => ({
      __proto__: dart.getGetters(DelegatingQueue.__proto__),
      [_baseQueue]: dart.fnType(collection.Queue$(E), [])
    }));
  ...
  src__wrappers.DelegatingMap$ = dart.generic((K, V) => {
    ...
    dart.setStaticMethodSignature(DelegatingMap, () => ({typed: dart.gFnType((K, V) => [core.Map$(K, V), [core.Map]])}));
  ...
  src__wrappers.MapKeySet$ = dart.generic(E => {
    ...
    dart.setGetterSignature(MapKeySet, () => ({
      ...
      [_base]: dart.fnType(core.Iterable$(E), [])
    }));
  ...
  src__wrappers.MapValueSet$ = dart.generic((K, V) => {
    ...
    dart.setGetterSignature(MapValueSet, () => ({
      ...
      [_base]: dart.fnType(core.Iterable$(V), []),
      isEmpty: dart.fnType(core.bool, []),
      [$isEmpty]: dart.fnType(core.bool, []),
      isNotEmpty: dart.fnType(core.bool, []),
      [$isNotEmpty]: dart.fnType(core.bool, []),
